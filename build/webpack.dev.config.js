...
var webpackConfig = {
  entry: {},
  output: {
    path: path.join(__dirname, "../dev"),//[师父加的注释] src改成了dist
    publicPath: "/",
  ...
  module: {
    loaders: [{
    ...
    },
     {
        ...
        //如下配置，将小于8192byte的图片转成base64码 name后面的值是相对于生成的index.html所在的文件夹
        test: /\.(png|jpg|gif)$/,
        loader: 'url-loader?limit=80&name=./static/images/[name].[ext]'
      },
      {
        //json文件加载器，json-loader
        test: /\.json$/,
        loader: 'json-loader?name=./static/json/[name].[ext]',
